...
public class MazeGenerator : MonoBehaviour
{
	...
	{
		size = difficulty == 1 ? 10 : difficulty == 2 ? 16 : difficulty == 3 ? 20 : difficulty == 4 ? 32 : 0;
		mapCam.orthographicSize = size * 2.5f;

		if (size == 0)
        {
			Debug.Log("Difficulty was not one of the preset difficulties (1, 2, 3, 4) maze generated stopped");
			return;
        }
